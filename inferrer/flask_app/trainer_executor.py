...
def set_client():
    ...
    tlsconfig = docker.TLSConfig(client_cert=("./utils/client/cert.pem","./utils/client/key.pem"), ca_cert="./utils/client/ca.pem")
...
def build_image():
    ...
    client.images.build(fileobj=CONTEXT, rm=True, pull=True, custom_context=True, dockerfile=UPLOADS_DIR+"Dockerfile", tag="trainer")
