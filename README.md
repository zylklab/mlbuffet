...
The two first methods, will remove the file set as default, and the last one will remove the specified version.
...
The two first methods, will download the file set as default, and the last one will download the specified version.

`wget http://localhost:8002/api/v1/models/<tag>/download --content-disposition`

You can also put the http petition in any browser too, and download the file.
